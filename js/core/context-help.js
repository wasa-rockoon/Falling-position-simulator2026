    ...
    var CONTENT = {
        ...
        uncertainty: {
            ...
            sections: [
                ...
                ['愛媛実験GO基準検証', '上昇速度−1/基準/+1 m/s、下降速度−3/基準/+3 m/s、破裂高度−20%/基準/+10%の全27条件を確認します。すべてが海上かつ最寄り海岸線から12 NM（22.224 km）以内ならGOです。1件でも陸上・内水面・距離超過ならNO-GO、海陸または距離を判定できない場合は判定不能です。'],
